...
**`tiempos.eleccionMaxima` (30 s) ya no termina nada**: si nadie agarró nada, muestra `opciones[0]` y la exploración sigue. Es la red de seguridad de la fila. Sin ella, quien no entiende el gesto deja el espejo tomado hasta el tope de sesión, tres minutos después. Y como lo ofrecido viene barajado, tomar el primero ya es un sorteo: nadie se va sin ingeniería.
