...
start "" "%CHROME%" --kiosk --user-data-dir="%~dp0..\.perfil-chrome" --autoplay-policy=no-user-gesture-required --use-fake-ui-for-media-stream --disable-infobars --disable-session-crashed-bubble --noerrdialogs --disable-features=Translate,TranslateUI "https://localhost:8080/espejo/espejo.html"
