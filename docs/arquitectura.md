...
| `planificador-detectores.js` | Mantiene los relojes independientes de rostro, manos y pose, y escalona su primer uso. Sólo avanza el reloj de un modelo cuando `main.js` confirma que realmente se ejecutó. |
